    ...
    positions: [
      {
        ...
        content: [
          {
            text: "Worked on projects using ReactJS,Tailwind,NextJS, NodeJS, ExpressJS and MongoDB",
            link: "",
          },
        ],
      },
...
export const extraCurricular = [
  {
    organisation: "Google Developer Student Club, kiitlogo",
    title: "Executive Member",
    duration: "December 2021 - Present",
    content: [
      {
        text: "Co-designed and developed the official website of Incident, kiitlogo with 15K+ visitors",
        link: "https://incident.kiitlogo.ac.in/",
      },
    ],
    logo: gdsc,
  },
  {
    organisation: "Genesis, kiitlogo",
    title: "Executive Member",
  ...
  {
    organisation: "IRIS, kiitlogo",
    title: "Tutor",
    duration: "Jan 2022 - Jan 2022",
    content: [
      {
        text: "Mentored 150+ students in a month-long Web Development and Ruby on Rails Bootcamp",
        link: "https://github.com/IRIS-kiitlogo/IRIS-RoR-Bootcamp-2021",
      },
    ],
    logo: techquench,
  },
  {
    organisation: "E-Cell, kiitlogo",
    title: "Executive Member",
    duration: "Sep 2021 - Apr 2022",
    content: [
      {
        text: "Organised the season 3 of the E-Cell kiitlogo Podcast",
...
export const aboutMe = {
  name: "Om Prakash",
  tagLine:
    "Web Developer | Android Developer | Executive Member at GDSC, kiitlogo",
  intro:
